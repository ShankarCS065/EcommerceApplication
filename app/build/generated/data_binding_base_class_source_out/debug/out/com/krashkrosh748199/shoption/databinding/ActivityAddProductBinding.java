...
public final class ActivityAddProductBinding implements ViewBinding {
  ...
  @NonNull
  public final MSPButton btnSubmitAddProduct;
  ...
  private ActivityAddProductBinding(@NonNull ConstraintLayout rootView,
      @NonNull MSPButton btnSubmitAddProduct, @NonNull MSPEditText etProductDescription,
    ...
    this.btnSubmitAddProduct = btnSubmitAddProduct;
  ...
  public static ActivityAddProductBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btn_submit_add_product;
      MSPButton btnSubmitAddProduct = ViewBindings.findChildViewById(rootView, id);
      if (btnSubmitAddProduct == null) {
        break missingId;
      }
      ...
      return new ActivityAddProductBinding((ConstraintLayout) rootView, btnSubmitAddProduct,
