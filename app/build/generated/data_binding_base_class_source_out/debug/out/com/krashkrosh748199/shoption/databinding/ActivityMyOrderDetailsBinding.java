...
public final class ActivityMyOrderDetailsBinding implements ViewBinding {
  ...
  @NonNull
  public final MSPTextView tvOrderDetailsIdNow;
  ...
  private ActivityMyOrderDetailsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MSPTextView tvOrderDetailsIdNow, @NonNull MSPTextView tvOrderDetailsShippingCharge,
    ...
    this.tvOrderDetailsIdNow = tvOrderDetailsIdNow;
  ...
  public static ActivityMyOrderDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_order_details_id_now;
      MSPTextView tvOrderDetailsIdNow = ViewBindings.findChildViewById(rootView, id);
      if (tvOrderDetailsIdNow == null) {
        break missingId;
      }
      ...
      return new ActivityMyOrderDetailsBinding((ConstraintLayout) rootView, rvMyOrderItemsList,
          ...
          tvMyOrderDetailsOtherDetails, tvOrderDetailsDate, tvOrderDetailsIdNow,
