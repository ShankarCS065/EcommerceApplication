...
public final class ActivitySoldProductDetailsBinding implements ViewBinding {
  ...
  @NonNull
  public final MSPTextViewBold tvSoldDetailsAddressType;

  @NonNull
  public final MSPTextView tvSoldDetailsFullName;
  ...
  private ActivitySoldProductDetailsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MSPTextViewBold tvSoldDetailsAddressType, @NonNull MSPTextView tvSoldDetailsFullName,
  ...
  public static ActivitySoldProductDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MSPTextViewBold tvSoldDetailsAddressType = ViewBindings.findChildViewById(rootView, id);
      if (tvSoldDetailsAddressType == null) {
        break missingId;
      }

      id = R.id.tv_sold_details_full_name;
      MSPTextView tvSoldDetailsFullName = ViewBindings.findChildViewById(rootView, id);
