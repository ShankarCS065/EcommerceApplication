...
public final class DialogProgressBinding implements ViewBinding {
  ...
  @NonNull
  public final MSPTextView tvProgressText;

  private DialogProgressBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull MSPTextView tvProgressText) {
  ...
  public static DialogProgressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MSPTextView tvProgressText = ViewBindings.findChildViewById(rootView, id);
