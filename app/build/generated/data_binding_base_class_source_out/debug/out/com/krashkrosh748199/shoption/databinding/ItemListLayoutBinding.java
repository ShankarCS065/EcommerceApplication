...
public final class ItemListLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final MSPTextViewBold tvItemName;

  @NonNull
  public final MSPTextView tvItemPrice;

  private ItemListLayoutBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MSPTextViewBold tvItemName, @NonNull MSPTextView tvItemPrice) {
  ...
  public static ItemListLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MSPTextViewBold tvItemName = ViewBindings.findChildViewById(rootView, id);
      if (tvItemName == null) {
        break missingId;
      }

      id = R.id.tv_item_price;
      MSPTextView tvItemPrice = ViewBindings.findChildViewById(rootView, id);
      if (tvItemPrice == null) {
        break missingId;
      }

      return new ItemListLayoutBinding((ConstraintLayout) rootView, ibDeleteProduct, ivItemImage,
          llItemImage, llProductDetails, tvItemName, tvItemPrice);
    }
